...
function transformBlockImage(graph, cell) {
    ...
    if (mxClient.IS_GC == true) {
        details['label'] = '<img src="' + style['imagePath'] + '" height=40px; width=40px; style="  transform:translate(' + point_x + 'px,' + point_y + 'px) rotate(' + cell.currentAngle + 'deg) scale(' + cell.flipX + ',' + cell.flipY + '); "/>';
    } else {
        details['label'] = '<img src="' + style['imagePath'] + '" height=40px; width=40px; style="  transform: rotate(' + cell.currentAngle + 'deg) scale(' + cell.flipX + ',' + cell.flipY + '); "/>';
    }
